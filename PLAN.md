...
| 2 USB transport | done in code (libusb FFI + Android bridge + fake/replay) — 19 tests; **hardware bring‑up pending** |
...
| 6 Curve tracer | done in code — five sweeps ported, plot, overlays, export; **hardware validation pending** |
