...
|---|---|---|---|
| Device enumerates (`just probe`) | ✅ 2026‑09‑05, bus 1 addr 1; USB string descriptors empty (product/serial come from STATE) | ✅ 2026‑09‑07, Pop!_OS 24.04 laptop, 0.1.0 release tarball + udev rule | ✅ 2026‑09‑06, USB OTG, release APK sideloaded |
...
## Linux (Pop!_OS 24.04, 2026‑09‑07)
